...
export default function AdminOverviewPage() {
  ...
  const filteredMarkets = useMemo(() => {
    ...
    // Filter by inbox (actionable only)
    if (filter === "inbox") {
      list = list.filter((m) => m.is_actionable);
    }
    ...
    <div className="min-h-screen bg-pump-dark">
          ...
          <>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <input
                ...
                className="w-full md:w-72 px-4 py-2 rounded-lg bg-pump-dark-lighter border border-white/10 text-white placeholder-gray-500 text-sm focus:outline-none focus:border-white/20"
              />
            </div>
      ...
      {drawerMarket && (
        <div className="fixed inset-0 z-50 flex">
          ...
          {/* Drawer Panel */}
          <div className="w-full max-w-md bg-pump-dark border-l border-white/10 flex flex-col">
